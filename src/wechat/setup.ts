  ...
  while (Date.now() < deadline) {
    ...
    switch (status.status) {
      ...
      case "confirmed": {
        ...
        console.log("  wechat-gemini-start");
        console.log("  wechat-copilot-start");
        console.log("  wechat-claude-start");
        console.log("  wechat-opencode-start");
        console.log();
        console.log("Repo-local development entrypoints are also available:");
        console.log("  bun run codex:start");
        console.log("  bun run gemini:start");
        console.log("  bun run copilot:start");
        console.log("  bun run claude:start");
        console.log("  bun run opencode:start");
        console.log();
        console.log("Manual bridge + companion entrypoints:");
        console.log("  bun run bridge:codex");
        console.log("  bun run bridge:gemini");
        console.log("  bun run bridge:copilot");
